...
def wav_to_spectrogram(audio_path, save_path, spectrogram_dimensions=(64, 64), noverlap=16, cmap='grey_r'):
    ...
    #ensure sample is max_s, append zeros if necessary
    max_s=0.5
    size=len(samples)/sample_rate
    if size<max_s:        
        diff=(max_s*sample_rate)-samples
        samples=np.append(samples, np.zeros(diff, dtype='int16'))
...
if __name__ == '__main__':
    audio_dir = "/home/rjames/Dropbox (The University of Manchester)/EarProject/free_digits/free-spoken-digit-dataset/recordings/" #"/Users/Jackson/development/free-spoken-digit-dataset/recordings/"

    spectrogram_dir = "/home/rjames/Dropbox (The University of Manchester)/EarProject/free_digits//free-spoken-digit-dataset/spectrograms/"#"/Users/Jackson/development/free-spoken-digit-dataset/spectrograms/"
