...
global  savedParamChanges savedBFlist saveAN_spikesOrProbability ...
    ...
    MOCattenuation ARattenuation VescRR IHCCiliaDis
...
VescRR=zeros(nANchannels,signalLength);
...
%         disp(num2str(max(linOutput)))
    ...
    IHCCiliaDis(:,segmentStartPTR:segmentStartPTR+segmentLength-1)=IHCciliaDisplacement;
    ...
    VescRR(:, segmentStartPTR:segmentStartPTR+segmentLength-1)=synapticCa;
